	...
	,mDynamicCubeMapDSV(NULL)
{
	...
	mDirLights[0].Diffuse  = XMFLOAT4(1.f, 1.f, 1.f, 1.0f);
	...
	mMeshMat.Diffuse  = XMFLOAT4(0.3f, 0.1f, 0.1f, 1.0f);
	mMeshMat.Specular = XMFLOAT4(0.1f, 0.1f, 0.1f, 1.0f);
	mMeshMat.roughness = 0.01f;
	mMeshMat.metal = 0.1f;
...
void D3DPBRApp::BuildGeometry()
{
	...
	geoGen.CreateSphere(5.f, 20, 20, sphere);
